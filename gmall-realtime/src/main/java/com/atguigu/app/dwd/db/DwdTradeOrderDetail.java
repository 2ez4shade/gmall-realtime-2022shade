...
public class DwdTradeOrderDetail {
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("create table dtopp( " +
                ...
                ")" + MyKafkaUtils.getKafkaDDL("dwd_trade_order_pre_process", "DwdTradeOrderDetail"));
        ...
        tableEnv.executeSql("create table restable( " +
                ...
                "`ts` string, " +
                "`row_op_ts` TIMESTAMP_LTZ(3) " +
                ")" + MyKafkaUtils.getInsertKafka("dwd_trade_order_detail"));
        tableEnv.executeSql("insert into restable select * from orderdetail");
    }
}
